...
function cavani_tm_popup(){
	...
	jQuery('.popup-youtube, .popup-vimeo, .popup-instagram').each(function() { // the containers for all your galleries
		jQuery(this).magnificPopup({
			disableOn: 700,
			type: 'iframe',
			mainClass: 'mfp-fade',
...
var instagramPopup = document.getElementById('popup-vimeo');
function popupInstagram() {
	var embed = [];
	embed.push(`<iframe width="560" height="315" src="https://www.youtube.com/embed/sHLVoL1tDR0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`);

	instagramPopup.innerHTML = embed.join('');
}
